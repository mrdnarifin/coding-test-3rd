...
export default function FundDetailPage() {
  ...
  const {
    data: capitalCalls,
    isLoading: capitalCallsLoading,
    error: capitalCallsError,
  } = useQuery({
  ...
  if (fundError) {
    return (
      <div className='text-red-600'>
        Error loading fund details: {(fundError as Error).message}
      </div>
    );
  }
  ...
  return (
    <div className='max-w-7xl mx-auto'>
      ...
      <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
        ...
        <MetricCard
          title='TVPI'
          value={metrics.tvpi ? metrics.tvpi.toFixed(2) + "x" : "N/A"}
        ...
        <MetricCard
          title='RVPI'
          value={metrics.rvpi ? metrics.rvpi.toFixed(2) + "x" : "N/A"}
        ...
        <MetricCard
          title='NAV'
          value={metrics.nav ? formatCurrency(metrics.nav) : "N/A"}
      ...
      <div className='grid lg:grid-cols-2 gap-6'>
        ...
        <div className='bg-white rounded-lg shadow-md p-6'>
          ...
          {capitalCallsLoading ? (
            ...
            <div className='text-red-600'>
              Error loading capital calls:{" "}
              {(capitalCallsError as Error).message}
            </div>
        ...
        <div className='bg-white rounded-lg shadow-md p-6'>
          ...
          {distributionsLoading ? (
            ...
            <div className='text-red-600'>
              ...
              {(distributionsError as Error).message}
            </div>
